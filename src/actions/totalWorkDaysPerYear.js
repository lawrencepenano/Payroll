...
/* DYNAMIC URL */
const url = '/api/total_work_days_per_year';
/* GET ALL RECORDS DISPATCH */
const GET_ALL_RECORDS = GET_TOTAL_WORK_DAYS_PER_YEAR;
/* GET RECORD DISPATCH */
const GET_RECORD = GET_WORK_DAYS_PER_YEAR;
/* CLEAR RECORD DISPATCH */
const CLEAR_RECORD = CLEAR_WORK_DAYS_PER_YEAR;
